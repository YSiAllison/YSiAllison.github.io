...
## Project 2: CNVreg Package to Perform Copy Number Variant Association Analysis with Penalied Regression (([CRAN]([https://github.com/Oceanyq/CNVreg](https://cran.r-project.org/web/packages/CNVreg));[Github](https://github.com/Oceanyq/CNVreg); [Vignette](https://cran.r-project.org/web/packages/CNVreg/vignettes/CNVReg_vig.html))
